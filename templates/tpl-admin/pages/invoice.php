...
<body>
    <div class="invoice">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-4 text-right">
                            ...
                            <!-- <a class="btn btn-success" id="keterangan-sewa" onclick="windowOnClick()>Cetak Invoice PDF</a> -->
                            <button class="btn btn-success btn-icon icon-left cetak-pdf" onclick="window.print()"><i class="fas fa-print"></i> Cetak Invoice</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <hr>
        <div class="text-md-left cetak-pdf">
            <?php
...
<!-- Modal Print Invoice -->
<div class="modal-backdrop" id="cetak-invoice" onclick="windowOnClick(this)">
